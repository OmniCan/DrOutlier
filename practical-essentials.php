<?php
/**
 * Practical Essentials (Table Viva) - Categories Page
 * Fetches and displays table viva categories from Laravel API
 */
...
$pageTitle = 'Practical Essentials - Dr. Outlier';
$user = getUser();
$token = getToken();
...
$response = apiRequest('/new-table-viva/categories', 'POST', [], $token);
...
$animations = [
    ...
    '/public/animantion/Green circle.json',
            ...
            <div class="macaroni-top">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="content">
                                <h2 class="text-white mb-0">Practical Essentials</h2>
                            </div>
                        </div>
                        <div class="col-lg-6 text-end">
                            <h6 class="text-white mb-0">Select Category</h6>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-4">
                        <?php foreach ($categories as $index => $category): ?>
                            ...
                            <div class="col-md-4 col-sm-6 col-6" style="padding: 18px; flex: 0 0 20%; max-width: 20%;">
                                <a href="/practical-essentials-chapters.php?id=<?php echo urlencode($categoryId); ?>" style="text-decoration: none;">
                                    <div class="box" style="display: flex; align-items: center; justify-content: center; text-align: center; border-radius: 15px; transition: all 0.3s ease; cursor: pointer; position: relative; width: 100%; aspect-ratio: 1 / 1;">
                                        ...
                                        <h6 style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: white; font-size: 16px; font-weight: 600; margin: 0; width: 75%; word-wrap: break-word; line-height: 1.3;">

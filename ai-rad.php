<?php
/**
 * AI-Rad (Exam Cases) - Categories Page
 * Fetches and displays exam case categories from Laravel API
 */
...
$response = apiRequest('/new-exam-cases/categories', 'POST', [], $token);
            ...
            <div class="macaroni-top">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="content">
                                <h2 class="text-white mb-0">AI-Rad Categories</h2>
                            </div>
                        </div>
                    ...
                    <div class="row g-4">
                        <?php foreach ($categories as $index => $category): ?>
                            ...
                            <div class="col-md-4 col-sm-6 col-6" style="padding: 18px; flex: 0 0 20%; max-width: 20%;">
                                <a href="/ai-rad-chapters.php?id=<?php echo urlencode($categoryId); ?>" style="text-decoration: none;">

...
function NewOsceChapters() {
    ...
    useEffect(() => {
        ...
        console.log('Fetching New OSCE chapters for category:', categoryId);
        ...
        axios.post(`${baseUrl}/api/new-osce/chapters`, {
            ...
            console.log('New OSCE Chapters API Response:', response);
            ...
            console.error('Error fetching New OSCE chapters:', error);
...
export default NewOsceChapters

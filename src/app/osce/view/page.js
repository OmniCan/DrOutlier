...
function Page() {
    ...
    useEffect(() => {
        ...
        axios.post(`${baseUrl}/api/osce/get-osce-by-id`, formData, {
            ...
            console.log('OSCE Data Full Response:', response?.data);
            console.log('OSCE Data:', response?.data?.data);
            console.log('Has question property?', 'question' in (response?.data?.data || {}));
            console.log('Question data:', response?.data?.data?.question);
            ...
            {!loading && osceData ? (
                <div style={{ width: '100%', minHeight: '100vh', position: 'relative', background: 'white' }}>
                    ...
                    <div style={{ 
                        ...
                        >
                            {osceData.question && Array.isArray(osceData.question) && osceData.question.length > 0 ? (
                                osceData.question.map((q, idx) => (
                                    <div key={idx} style={{ 
                                        display: 'flex',
                                        flexDirection: 'column',
                                        gap: '8px'

...
function page() {
    ...
    const [allnotes, SaveAllnotes] = useState([])
    ...
    useEffect(() => {
        ...
        axios.post(`${baseUrl}/api/watch-and-learn-category/get-watch-bookmark=${userid}`,
            {}, {
            headers: {
                'Authorization': `Bearer ${cookies}`
            }
        }).then((e) => SaveAllnotes(e.data.data))
    }, [])
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4">
                                    <div className="content">
                                        <h2 className="text-white mb-0">Save Watch And Lern</h2>
                                    </div>
                                </div>

                                        ...
                                        <div className="col-12">
                                            <div style={{ 
                                                ...
                                                {currentChapterIndex > 0 ? (
                                                    <Link href={`/theory-notes/category?id=${allChapters[currentChapterIndex - 1].id}${parentCategoryId ? `&parentId=${parentCategoryId}` : ''}`}>
                                                        <button style={{ 
                                                            padding: '15px 30px',
                                                            background: 'linear-gradient(150deg, #44A6C5 0%, #1E4FFD 100%)',
                                                            borderRadius: '12px',
...
export default TheoryNotesCategory

...
function NewExamCasesViewer() {
    ...
    useEffect(() => {
        ...
        axios.post(`${baseUrl}/api/new-exam-cases/items-by-chapter`, {
            ...
            if (parentCategoryId) {
                ...
                // No parent ID - try to get all new-exam-cases categories
                axios.get(`${baseUrl}/api/new-exam-cases/categories`, {
                    headers: {
                        'Authorization': `Bearer ${cookies}`
                    }
    ...
    const saveBookmark = (itemId) => {
        ...
        axios.post(`${baseUrl}/api/new-exam-cases/toggle-bookmark`, formData, {
            headers: {
                'Authorization': `Bearer ${cookies}`,
            }
        })
                                    ...
                                    {allChapters.length > 0 && (
                                        ...
                                        >
                                            ...
                                            {currentChapterIndex > 0 ? (
                                                <Link href={`/new-exam-cases/category?id=${allChapters[currentChapterIndex - 1].id}${parentId ? `&parentId=${parentId}` : ''}`}>
                                                    <button style={{ 
                                                        padding: '12px 24px',
                        ...
                        <div className="container" style={{ maxWidth: '1140px', marginTop: '40px' }}>
                            <div style={{ background: 'white', borderRadius: '24px', padding: '60px' }}>
                                <div style={{ textAlign: 'center' }}>
                                    ...
                                    <Link href={`/new-exam-cases/category?id=${categoryId}${parentId ? `&parentId=${parentId}` : ''}`} style={{
                                        padding: '12px 30px',
...
export default NewExamCasesViewer

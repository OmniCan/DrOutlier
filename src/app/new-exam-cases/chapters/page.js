...
function NewExamCasesChapters() {
    ...
    useEffect(() => {
        ...
        console.log('Fetching New Exam Cases chapters for category:', categoryId);
        ...
        axios.post(`${baseUrl}/api/new-exam-cases/chapters`, {
            ...
            console.log('New Exam Cases Chapters API Response:', response);
            ...
            console.error('Error fetching New Exam Cases chapters:', error);
...
export default NewExamCasesChapters

    ...
    useEffect(() => {
        const fetchBookmarks = async () => {
            try {
                ...
                if (!userToken || !userId) {
                    console.error("Missing user token or user ID");
                    setLoading(false);
                    return;
                }

                const response = await axios.post(
                    `${baseUrl}/api/basic-category/get-basic-bookmark?user_id=${userId}`,
                    {},
                    {
                        headers: {
                ...
                if (response.data?.data?.list) {
                    SaveAllnotes(response.data.data.list);
                } else {
                                ...
                                <div className="row">
                                    <Link href='/'>
                                        ...
                                        <div className="col-5 text-center">
                                            <h6>Saved Practical Essentials</h6>
                                        </div>
                                        <div className="col-4" />
                                    </Link>
                                </div>

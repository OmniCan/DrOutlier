...
function page() {
    ...
    useEffect(() => {
        ...
        axios.post(`${baseUrl}/api/basic-category/category-basic?page=1&category=${categoryId}`, {}, {
            ...
            setBasics(basicsList);
            
            // Get category name from the first basic if available
            if (basicsList.length > 0 && basicsList[0].category) {
                setCategoryName(basicsList[0].category.name || 'Practical Essentials');
            } else {
            ...
            axios.post(`${baseUrl}/api/basic-category/get-basic-bookmark`, bookmarkFormData, {
                ...
                console.error("Error fetching bookmarked basics:", error);
            });
    ...
    // Generate color variations for basics (similar to categories)
                ...
                <div className="main-wrapper">
                                ...
                                <div className="container">
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-lg-6 text-end">
                                            <h6 className="text-white mb-0">Select Table Viva</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="row g-4">
                                        {basics && basics.length > 0 ? (
                                            basics?.map((basic, index) => (
                                                <div className="col-md-4 col-sm-6 col-6" key={basic.id} style={{ padding: '12px', flex: '0 0 16.666%', maxWidth: '16.666%' }}>
                                                    <Link href={`/practical-essentials/view?id=${categoryId}&basicId=${basic.id}#page${index + 1}`}>
                    ...
                    <section className="Macaroni-sign-page-mobile p-0 d-block d-lg-none">
                        <div className="Macaroni-top">
                            <div className="container">
                                <div className="row">
                                    <Link href='/practical-essentials'>
                                        <div className="col-4">
                        ...
                        <div className="Macaroni-middle" style={{ paddingTop: '20px' }}>
                            <div className="container">
                                <div className="row g-3">
                                    {basics && basics.length > 0 ? (
                                        basics?.map((basic, index) => (
                                            <div className="col-6" key={basic.id}>
                                                <Link href={`/practical-essentials/view?id=${categoryId}&basicId=${basic.id}#page${index + 1}`}>
                                                    <div className="box" style={{ 
                                                        display: 'flex', 

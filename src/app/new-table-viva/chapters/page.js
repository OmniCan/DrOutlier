...
function NewTableVivaChapters() {
    ...
    useEffect(() => {
        ...
        console.log('Fetching New Table Viva chapters for category:', categoryId);
        ...
        axios.post(`${baseUrl}/api/new-table-viva/chapters`, {
            ...
            console.log('New Table Viva Chapters API Response:', response);
            ...
            console.error('Error fetching New Table Viva chapters:', error);
                                    ...
                                    <div className="list-wrapper" style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                                        {chapters && chapters.length > 0 ? (
                                            chapters?.map((chapter, index) => (
                                                <Link href={`/new-table-viva/category?id=${chapter.id}&parentId=${categoryId}`} key={chapter.id} style={{ textDecoration: 'none' }}>
                        ...
                        <div className="Macaroni-middle" style={{ paddingTop: '20px' }}>
                            <div className="container">
                                <div className="list-wrapper" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    {chapters && chapters.length > 0 ? (
                                        chapters?.map((chapter, index) => (
                                            <Link href={`/new-table-viva/category?id=${chapter.id}`} key={chapter.id} style={{ textDecoration: 'none' }}>
                                                <div className="list-item" style={{ 
                                                    display: 'flex', 
                                                    alignItems: 'center', 
                                                    padding: '15px 20px',
...
export default NewTableVivaChapters

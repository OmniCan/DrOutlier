...
function NewTableVivaViewer() {
        ...
        axios.post(`${baseUrl}/api/new-table-viva/items-by-chapter`, {
            ...
            if (itemsList.length > 0) {
                ...
                if (itemsList[0].pdf_file) {
                    const pdfPath = `${baseUrl}/assets/new_table_viva_pdf/${itemsList[0].pdf_file}`;
            ...
            if (itemId && itemsList.length > 0) {
                ...
                if (itemIndex !== -1) {
                    ...
                    if (itemsList[itemIndex].pdf_file) {
                        const pdfPath = `${baseUrl}/assets/new_table_viva_pdf/${itemsList[itemIndex].pdf_file}`;
                        const proxyUrl = `/api/proxy-pdf?url=${encodeURIComponent(pdfPath)}`;
                        setPdfUrl(proxyUrl);
                    }
                }
    ...
    useEffect(() => {
        if (currentItem && currentItem.pdf_file) {
            const pdfPath = `${baseUrl}/assets/new_table_viva_pdf/${currentItem.pdf_file}`;

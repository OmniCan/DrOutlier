...
<div class="row mb-none-30">
    <div class="col-lg-12 mb-30">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.new-exam-cases.new-exam-cases-update' , $spotters->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="sort_order" id="sort_order" value="{{$spotters->sort_order}}" class="form-control" placeholder="@lang('Enter sort order')" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                @if($spotters->image)
                                    <img src="{{getImage(getFilePath('NewExamCasesImage').'/'.@$spotters->image)}}" width="100" height="100"/>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor form-control" name="description">{{$spotters->description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="is_premium">
                                    <option value="0" {{ $spotters->is_premium == 0 ? 'selected' : '' }}>Free</option>
                                    <option value="1" {{ $spotters->is_premium == 1 ? 'selected' : '' }}>Premium</option>
                                </select>
                            </div>
                        </div>
...
<a href="{{route('admin.new-exam-cases.new-exam-cases-index')}}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="las la-angle-double-left"></i>@lang('Go Back')</a>
@endpush

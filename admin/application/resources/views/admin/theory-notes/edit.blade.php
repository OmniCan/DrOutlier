...
<div class="row mb-none-30">
    <div class="col-lg-12 mb-30">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.theory-notes.theory-notes-update' , $spotters->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                @if($spotters->image)
                                    <img src="{{getImage(getFilePath('TheoryNotesImage').'/'.@$spotters->image)}}" width="100" height="100"/>
                                @endif
                            </div>
                        </div>
...
<a href="{{route('admin.theory-notes.theory-notes-index')}}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="las la-angle-double-left"></i>@lang('Go Back')</a>
@endpush

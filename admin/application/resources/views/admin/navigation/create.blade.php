                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" value="{{old('title')}}" class="form-control" placeholder="@lang('e.g., Notes')" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" id="type" required>
                                    <option value="module" {{ old('type') == 'module' ? 'selected' : '' }}>@lang('Module (Linked to Module)')</option>
                                    <option value="custom" {{ old('type') == 'custom' ? 'selected' : '' }}>@lang('Custom (Internal Link)')</option>
                                    <option value="external" {{ old('type') == 'external' ? 'selected' : '' }}>@lang('External (External Link)')</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="visibility_type" id="visibility_type" required>
                                    <option value="public" {{ old('visibility_type', 'public') == 'public' ? 'selected' : '' }}>@lang('Public (Show to Everyone)')</option>
                                    <option value="subscription" {{ old('visibility_type') == 'subscription' ? 'selected' : '' }}>@lang('Subscription Based (Show Based on Plan Access)')</option>
                                    <option value="auth" {{ old('visibility_type') == 'auth' ? 'selected' : '' }}>@lang('Authenticated Only (Logged in Users)')</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="module_id" id="module_id">
                                    ...
                                    @foreach($modules as $module)
                                        <option value="{{ $module->id }}" data-url="{{ $module->frontend_url }}" {{ old('module_id') == $module->id ? 'selected' : '' }}>
                                            {{ $module->display_name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="url" id="url" value="{{old('url')}}" class="form-control" placeholder="@lang('/notes')" required>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="icon" id="icon" value="{{old('icon')}}" class="form-control" placeholder="@lang('las la-sticky-note')">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" name="show_in_navbar" id="show_in_navbar" value="1" {{ old('show_in_navbar', true) ? 'checked' : '' }}>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="form-check mt-4">
                                    <input class="form-check-input" type="checkbox" name="requires_auth" id="requires_auth" value="1" {{ old('requires_auth') ? 'checked' : '' }}>

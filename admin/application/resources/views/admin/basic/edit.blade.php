...
<div class="row mb-none-30">
    <div class="col-lg-12 mb-30">
        <div class="card">
            <div class="card-body"> 
                <form action="{{route('admin.basic.basic-update' , $basic->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    <optgroup label="{{$cat->name}}"> 
                                     ...
                                     <option value="{{$child->id}}" {{($basic->category == $child->id)?'selected':''}}>{{$child->name}}</option> 
                                    @endforeach
                                      </optgroup>
                                    @endforeach
                                    @endif 
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" value="{{$basic->title}}" class="form-control" placeholder="@lang('Enter Title')" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="sort_order" id="sort_order" value="{{$basic->sort_order}}" class="form-control" placeholder="@lang('Enter sort order')" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                rows="10">{{$basic->content}}</textarea>
                            </div>
                        </div>

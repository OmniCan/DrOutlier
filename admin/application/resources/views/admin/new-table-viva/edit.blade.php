...
<div class="row mb-none-30">
    <div class="col-lg-12 mb-30">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.new-table-viva.new-table-viva-update' , $spotters->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                @if($spotters->image)
                                    <img src="{{getImage(getFilePath('NewTableVivaImage').'/'.@$spotters->image)}}" width="100" height="100"/>
                                @endif
                            </div>
                        </div>

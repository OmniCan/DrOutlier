...
<div class="row mb-none-30">
    <div class="col-lg-12 mb-30">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.practical-essentials-category.update' , $category->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="is_premium">
                                    <option value="0" {{ $category->is_premium == 0 ? 'selected' : '' }}>Free</option>
                                    <option value="1" {{ $category->is_premium == 1 ? 'selected' : '' }}>Premium</option>
                                </select>
                            </div>
                        </div>
...
<a href="{{route('admin.practical-essentials-category.index')}}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="las la-angle-double-left"></i>@lang('Go Back')</a>
@endpush

...
<div class="row mb-none-30">
    <div class="col-lg-12 mb-30">
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.osce.osce-store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row container">
                        ...
                        <div id="fields-container">
                            <div class="row field-set" id="section-1">
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        <label for="question-1" class="font-weight-bold">@lang('Question')</label>
                                        <input type="text" name="question[]" id="question-1" value="{{old('question')}}" class="form-control" placeholder="@lang('Enter question')" required>
                                    </div>
                                </div>
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        <label for="answer-1" class="font-weight-bold">@lang('Answer')</label>
                                        <input type="text" name="answer[]" id="answer-1" value="{{old('answer')}}" class="form-control" placeholder="@lang('Enter answer')" required>
                                    </div>
                                </div>
                                <div class="col-lg-2">
...
<a href="{{route('admin.osce.osce-index')}}" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="las la-angle-double-left"></i>@lang('Go Back')</a>
@endpush

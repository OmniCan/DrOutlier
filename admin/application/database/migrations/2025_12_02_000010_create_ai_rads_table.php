...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ai_rads', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('category')->comment('This refers to chapter from ai_rads_categories table');
            $table->string('title');

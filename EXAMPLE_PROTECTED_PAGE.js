...
function PracticalEssentialsPage() {
    ...
    useEffect(() => {
        ...
        axios.post(`${baseUrl}/api/basic-category/list`, {}, {
            ...
            if (error.response?.status === 403) {
                // User doesn't have access - let the ModuleAccessGuard handle it
                setLoading(false);
            } else {
                setLoading(false);
            }
    ...
    // Wrap content with ModuleAccessGuard
    return (
        <ModuleAccessGuard moduleSlug="practical-essentials">
            {content}
        </ModuleAccessGuard>
    );
}

export default PracticalEssentialsPage;

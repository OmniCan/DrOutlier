<?php
/**
 * Watch & Learn - Categories Page
 * Fetches and displays watch & learn categories from Laravel API
 */
...
$response = apiRequest('/watch-and-learn-category/list', 'POST', [], $token);
            ...
            <div class="macaroni-top">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="content">
                                <h2 class="text-white mb-0">Watch & Learn</h2>
                            </div>
                        </div>
                    ...
                    <div class="row g-4">
                        <?php foreach ($categories as $index => $category): ?>
                            ...
                            <div class="col-md-4 col-sm-6 col-6" style="padding: 18px; flex: 0 0 20%; max-width: 20%;">
                                <a href="/watch-learn-videos.php?id=<?php echo urlencode($categoryId); ?>" style="text-decoration: none;">

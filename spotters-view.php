...
if ($chapterId) {
    $response = apiRequest('/api/new-spotters/items-by-chapter', 'POST', ['chapter_id' => $chapterId], $token);
...
function loadPDF() {
    ...
    const pdfUrl = 'https://admin.droutlier.com/assets/spotter_pdf/' + currentItem.pdf_file;
